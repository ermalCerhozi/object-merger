...
import { DiffTableRowResult, DiffLineResult, DiffPart } from '../models/text-diff.model';
...
export class DiffService {
  ...
  private formatOutput(diffs: Diff[]): DiffTableRowResult[] {
    ...
    return diffs.reduce((rows: DiffTableRowResult[], diff: Diff) => {
      ...
      let leftDiffRow: DiffTableRowResult | null | undefined = null;
      let rightDiffRow: DiffTableRowResult | null | undefined = null;
